...
export class PaymentController {
    ...
    async processPayment(req: Request, res: Response): Promise<void> {
        ...
        try {
            ...
            if (error instanceof PaymentError) {
                await this.emitErrorAndRespond(res, error, error.message, traceId, req.body);
            } else {
                await this.emitErrorAndRespond(res, error, "Payment processing failed", traceId, req.body);
            }
        }
    }
    ...
    async getPaymentById(req: Request, res: Response): Promise<void> {
        ...
        try {
            ...
            await this.emitErrorAndRespond(res, error, "Failed to fetch payment", traceId, { id: req.params.id });
        }
    }
    ...
    async getPaymentByOrderId(req: Request, res: Response): Promise<void> {
        ...
        try {
            ...
            await this.emitErrorAndRespond(res, error, "Failed to fetch payment", traceId, { orderId: req.params.orderId });
        }
    }
    ...
    async getAllPayments(req: Request, res: Response): Promise<void> {
        ...
        try {
            ...
            await this.emitErrorAndRespond(res, error, "Failed to fetch payments", traceId);
        }
    }
