...
export class ProductController {
    ...
    async getAllProducts(req: Request, res: Response): Promise<void> {
        ...
        try {
            ...
            await this.emitErrorAndRespond(res, error, "Failed to fetch products", traceId, {});
        }
    }
    ...
    async getProductById(req: Request, res: Response): Promise<void> {
        ...
        try {
            ...
            await this.emitErrorAndRespond(res, error, "Failed to fetch product", traceId, { id: req.params.id });
        }
    }
    ...
    async createProduct(req: Request, res: Response): Promise<void> {
        ...
        try {
            ...
            await this.emitErrorAndRespond(res, error, "Failed to create product", traceId, req.body);
        }
    }
    ...
    async updateProduct(req: Request, res: Response): Promise<void> {
        ...
        try {
            ...
            await this.emitErrorAndRespond(res, error, "Failed to update product", traceId, { id: req.params.id, data: req.body });
        }
    }
    ...
    async deleteProduct(req: Request, res: Response): Promise<void> {
        ...
        try {
            ...
            await this.emitErrorAndRespond(res, error, "Failed to delete product", traceId, { id: req.params.id });
        }
    }
    ...
    async checkInventory(req: Request, res: Response): Promise<void> {
        ...
        try {
            ...
            const available = await this.productService.checkInventory(id, parseInt(quantity as string, 10) || 1, traceId);
            res.json({
                success: true,
                available,
                traceId
            ...
            await this.emitErrorAndRespond(res, error, "Failed to check inventory", traceId, { id: req.params.id, quantity: req.query.quantity });
        }
    }
